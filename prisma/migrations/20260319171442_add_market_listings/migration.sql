...
CREATE TABLE "TeamContextEntry" (
    ...
    CONSTRAINT "TeamContextEntry_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "MarketListing_ref_key" ON "MarketListing"("ref");

-- CreateIndex
CREATE UNIQUE INDEX "MarketListing_digest_key" ON "MarketListing"("digest");

-- CreateIndex
CREATE INDEX "MarketReview_listingId_idx" ON "MarketReview"("listingId");

-- CreateIndex
CREATE UNIQUE INDEX "MarketReview_listingId_userId_key" ON "MarketReview"("listingId", "userId");
...
-- AddForeignKey
ALTER TABLE "TeamContextEntry" ADD CONSTRAINT "TeamContextEntry_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "Account"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Genome" ADD CONSTRAINT "Genome_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "Account"("id") ON DELETE CASCADE ON UPDATE CASCADE;
